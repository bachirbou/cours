...
/* la fonc uti pr oppos a predef est cell qui n exist pas.
 que nous allons coder par nos propre besoi, par rapport aux fctn du site */

function salut($p){
    echo 'salut' .$p .'<br>';
}

// para qui sera donne au moment ou l'on execute. ce para etant envoye en ligne 146 pr etre conca au rst de la chaine de cara 
